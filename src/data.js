...
export const ui = {
  nl: {
    ...
    section: {
      ...
      cashOnDelivery: "Alleen online betalen",
      payAtRestaurant: "Alleen online betalen",
      molliePayment: "Online met kaart betalen",
      stripePayment: "Online met kaart betalen",
      ...
      stripeUnavailable: "Online kaartbetaling is tijdelijk niet beschikbaar. Bel het restaurant.",
      stripeMissingBackend: "Online kaartbetaling is tijdelijk niet beschikbaar. Bel het restaurant.",
      stripeMissingConfig: "Online kaartbetaling is tijdelijk niet beschikbaar. Bel het restaurant.",
      mollieRedirect: "Je wordt doorgestuurd naar Mollie om veilig met kaart te betalen.",
      mollieUnavailable: "Online kaartbetaling is tijdelijk niet beschikbaar. Bel het restaurant.",
      mollieMissingBackend: "Online kaartbetaling is tijdelijk niet beschikbaar. Bel het restaurant.",
      mollieMissingConfig: "Online kaartbetaling is tijdelijk niet beschikbaar. Bel het restaurant.",
  ...
  ar: {
    ...
    section: {
      ...
      stripeUnavailable: "الدفع أونلاين غير متاح مؤقتاً. اختر الدفع نقداً أو في المطعم.",
      stripeMissingBackend: "الدفع أونلاين غير متاح مؤقتاً. اختر الدفع نقداً أو في المطعم.",
      stripeMissingConfig: "الدفع أونلاين غير متاح مؤقتاً. اختر الدفع نقداً أو في المطعم.",
      mollieRedirect: "سيتم تحويلك إلى Mollie للدفع الآمن.",
      mollieUnavailable: "الدفع أونلاين غير متاح مؤقتاً. اختر الدفع نقداً أو في المطعم.",
      mollieMissingBackend: "الدفع أونلاين غير متاح مؤقتاً. اختر الدفع نقداً أو في المطعم.",
      mollieMissingConfig: "الدفع أونلاين غير متاح مؤقتاً. اختر الدفع نقداً أو في المطعم.",
  ...
  de: {
    ...
    section: {
      ...
      stripeUnavailable: "Online-Zahlung ist vorübergehend nicht verfügbar. Wähle Barzahlung oder Zahlung im Restaurant.",
      stripeMissingBackend: "Online-Zahlung ist vorübergehend nicht verfügbar. Wähle Barzahlung oder Zahlung im Restaurant.",
      stripeMissingConfig: "Online-Zahlung ist vorübergehend nicht verfügbar. Wähle Barzahlung oder Zahlung im Restaurant.",
      mollieRedirect: "Du wirst zu Mollie weitergeleitet, um sicher zu bezahlen.",
      mollieUnavailable: "Online-Zahlung ist vorübergehend nicht verfügbar. Wähle Barzahlung oder Zahlung im Restaurant.",
      mollieMissingBackend: "Online-Zahlung ist vorübergehend nicht verfügbar. Wähle Barzahlung oder Zahlung im Restaurant.",
      mollieMissingConfig: "Online-Zahlung ist vorübergehend nicht verfügbar. Wähle Barzahlung oder Zahlung im Restaurant.",
